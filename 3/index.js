...
$(document).ready(function() {
    ...
    $('.next_button').css('cursor', 'pointer').click(function(){ window.location = '../4/index.html'; });
		$('.footer .wlby_2, .footer .wlby_3, .footer .wlby_4').css('cursor', 'pointer').click(function(){ window.location = 'http://www.coffeeandcode.com'; });
});
